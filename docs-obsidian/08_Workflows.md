...
### Al terminar una sesión o pedir "pushea"

El protocolo de push es:
```
1. Actualizar docs-obsidian/ (automático — no hace falta pedirlo)
   - 06_Changelog.md — qué se construyó
   - 04_Errors.md — bugs resueltos / nuevos
   - 03_Decisions.md — decisiones tomadas
   - Daily/YYYY-MM-DD.md — resumen de sesión
   - 00_Index.md — si el estado general cambió

2. git add [archivos de código]
3. git commit + git push
```

> `docs-obsidian/` está en `.gitignore` — nunca va en el commit. Se mantiene local.
